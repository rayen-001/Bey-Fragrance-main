    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#050505] border border-[#d4af37]/20 rounded-2xl w-full max-w-2xl lg:max-w-4xl shadow-2xl relative flex flex-col max-h-[90vh] overflow-hidden"
        ...
        >
          ...
          {/* Left Side: Gallery (Now Top on all sizes) */}
          <div className="w-full relative bg-[#0a0a0a] min-h-[300px] md:min-h-[400px] overflow-hidden border-b border-white/5 group flex-shrink-0">
